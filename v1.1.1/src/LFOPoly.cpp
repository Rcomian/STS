...
struct LFOPoly : Module
{
    ...
    LFOPoly()
    {
        ...
        for (int i = 0; i < 16; ++i)
        {
            ...
            configParam(PH_PARAM + i, 0.5f, -0.5f, 0.0f, "Phase ", "%", 0.f, 100.f);
...
struct LFOPolyWidget : ModuleWidget
{
    ...
    LFOPolyWidget(LFOPoly *module)
    {
        ...
        for (int i = 0; i < 8; ++i)
        {
            ...
            addParam(createParamCentered<sts_Davies_25_Red>(Vec(portY + i * y1, portx[2]), module, LFOPoly::FREQ_PARAM + i));
            addParam(createParamCentered<sts_Davies_25_Blue>(Vec(portY + i * y1, portx[3]), module, LFOPoly::WAVE_PARAM + i));
            addParam(createParamCentered<sts_Davies_25_Teal>(Vec(portY + i * y1, portx[4]), module, LFOPoly::PW_PARAM + i));
            addParam(createParamCentered<sts_Davies_25_Yellow>(Vec(portY + i * y1, portx[5]), module, LFOPoly::PH_PARAM + i));
        }

        for (int i = 8; i < 16; ++i)
        {
            addChild(createLightCentered<SmallLight<GreenRedLight>>(Vec(portY + (i - 8) * y1, portx[0] + x2), module, LFOPoly::PHASE_LIGHTS + i * 2));
            addParam(createParamCentered<sts_Davies_25_Red>(Vec(portY + (i - 8) * y1, portx[2] + x2), module, LFOPoly::FREQ_PARAM + i));
            addParam(createParamCentered<sts_Davies_25_Blue>(Vec(portY + (i - 8) * y1, portx[3] + x2), module, LFOPoly::WAVE_PARAM + i));
            addParam(createParamCentered<sts_Davies_25_Teal>(Vec(portY + (i - 8) * y1, portx[4] + x2), module, LFOPoly::PW_PARAM + i));
        ...
        addInput(createInputCentered<sts_Port>(Vec(portY + y1 * 4, 350), module, LFOPoly::PH_INPUT));
