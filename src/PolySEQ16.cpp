...
struct PolySEQ16 : Module
{
	...
	void process(const ProcessArgs &args) override
	{
		...
		for (int i = 0; i < 16; i++)
		{
			//this->param1[i]->snap = true;
			//param1[i]->smooth = false;
			//sts_Davies_snap_25_Red *param2;
			//sts_Davies_snap_25_Blue *param3;
			//sts_Davies_snap_25_Teal *param4;
		}
...
struct PolySEQ16Widget : ModuleWidget
{
	...
	PolySEQ16Widget(PolySEQ16 *module)
	{
		...
		for (int i = 0; i < 16; i++)
		{
			...
			//Gate 1 Green
			addParam(createParamCentered<stsLEDButtonSmall>(Vec(locX[i] - 8, locY[4]), module, PolySEQ16::GATE_PARAM_R1 + i));
			addChild(createLightCentered<SmallLight<GreenLight>>(Vec(locX[i] - 8, locY[4]), module, PolySEQ16::GATE_LIGHTS_R1 + i));
			//Gate 2 Blue
			addParam(createParamCentered<stsLEDButtonSmall>(Vec(locX[i] + 8, locY[4]), module, PolySEQ16::GATE2_PARAM_R1 + i));
			addChild(createLightCentered<SmallLight<BlueLight>>(Vec(locX[i] + 8, locY[4]), module, PolySEQ16::GATE2_LIGHTS_R1 + i));
			//Trigger 1 Red
			addParam(createParamCentered<stsLEDButtonSmall>(Vec(locX[i], locY[5]), module, PolySEQ16::TRIG_PARAM_R1 + i));
			addChild(createLightCentered<SmallLight<RedLight>>(Vec(locX[i], locY[5]), module, PolySEQ16::TRIG_LIGHTS_R1 + i));
			...
			addParam(createParamCentered<stsLEDButtonSmall>(Vec(locX[i] - 8, locY[8]), module, PolySEQ16::GATE_PARAM_R2 + i));
			addChild(createLightCentered<SmallLight<GreenLight>>(Vec(locX[i] - 8, locY[8]), module, PolySEQ16::GATE_LIGHTS_R2 + i));
